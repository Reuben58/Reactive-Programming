...
public class MovieInfoControllerUnitTest {
  ...
  void getMovieInfoById() {
    ...
    var movieInfoForId = new MovieInfo("abc", "Dark Knight Rises",
            2012, List.of("Christian Bale", "Tom Hardy"), LocalDate.parse("2012-07-20"));

    when(moviesInfoServiceMock.getMovieInfoById(anyString())).thenReturn(Mono.just(movieInfoForId));
    ...
    webTestClient
            ...
            .consumeWith(movieInfoResponseBody -> {
              var movieInfoForThisId = movieInfoResponseBody.getResponseBody();
              assertNotNull(movieInfoForThisId);
              assertEquals(movieInfoForThisId.getMovieInfoId(), id);
              assertEquals(movieInfoForThisId.getName(), "Dark Knight Rises");
            });
  }
...
//    }
  ...
  void updateMovieInfo() {
    ...
    var updatedMovieInfo = new MovieInfo("abc", "Dark Knight Rises 1",
            2013, List.of("Christian Bale 1", "Tom Hardy 1"), LocalDate.parse("2012-07-20"));
  ...
  void deleteMovieInfo() {
    ...
    when(moviesInfoServiceMock.deleteMovieInfoById(anyString())).thenReturn(Mono.empty());
